...
class LogMonitor:
    ...
    def __init__(self, log_dir: str = "logs"):
        ...
        self.target_node_patterns = [
            ...
            'app.engines.insight.nodes.summary_node',  # InsightEngine完整路径
            'app.engines.media.nodes.summary_node',  # MediaEngine完整路径
            'app.engines.query.nodes.summary_node',  # QueryEngine完整路径
    ...
    def is_target_log_line(self, line: str) -> bool:
        ...
        2. 完整模块路径：app.engines.insight.nodes.summary_node、app.engines.media.nodes.summary_node、app.engines.query.nodes.summary_node
