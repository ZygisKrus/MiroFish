...
使用方法:
    python -m app.engines.report.scripts.validate_ir chapter-030-section-3-0.json
    python -m app.engines.report.scripts.validate_ir *.json --fix
    python -m app.engines.report.scripts.validate_ir ./output/ --recursive --fix --verbose
"""
