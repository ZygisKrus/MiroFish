...
@report_engine_bp.route('/status', methods=['GET'])
def get_status():
    """
...
@report_engine_bp.route('/generate', methods=['POST'])
def generate_report():
    """
    开始生成报告。
...
@report_engine_bp.route('/progress/<task_id>', methods=['GET'])
...
@report_engine_bp.route('/stream/<task_id>', methods=['GET'])
...
@report_engine_bp.route('/result/<task_id>', methods=['GET'])
...
@report_engine_bp.route('/result/<task_id>/json', methods=['GET'])
...
@report_engine_bp.route('/download/<task_id>', methods=['GET'])
...
@report_engine_bp.route('/cancel/<task_id>', methods=['POST'])
...
@report_engine_bp.route('/templates', methods=['GET'])
def get_templates():
    """
...
# 错误处理
@report_engine_bp.errorhandler(404)
def not_found(error):
...
@report_engine_bp.errorhandler(500)
...
@report_engine_bp.route('/log', methods=['GET'])
def get_report_log():
    """
...
@report_engine_bp.route('/log/clear', methods=['POST'])
def clear_log():
    """
...
@report_engine_bp.route('/export/md/<task_id>', methods=['GET'])
...
@report_engine_bp.route('/export/pdf/<task_id>', methods=['GET'])
...
@report_engine_bp.route('/export/pdf-from-ir', methods=['POST'])
