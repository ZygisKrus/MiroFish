...
def run_scenario(scenario_name, marketing_strategy, requirement_keyword):
    print(f"\n{'='*50}")
    ...
    # 6. Start Simulation
    print("\n[Step 6] Starting Simulation (200 rounds)...")
    data = {
...
def main():
    print("Starting A/B/C Testing for Fizkonspektas Launch (Subscription Trap Scenarios)")
